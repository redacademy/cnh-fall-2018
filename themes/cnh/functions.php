...
function cnh_scripts() {
  ...
  wp_enqueue_script( 'cnh-custom-js', get_template_directory_uri() . '/build/js/custom.min.js', array('jquery'), '20181205', true );
  
  wp_enqueue_script('jquery.selectric.min.js', get_template_directory_uri() . '/build/js/selectric.min.js', array(), '20181206', true);
