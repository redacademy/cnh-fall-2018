<?php
/**
 * The template for displaying all Seniors - fitness programs.
 *
 * @package based on RED_Starter_Theme
 * Template Name: Seniors - Fitness Programs Template
 */
get_header(); ?>
...
<div id="primary" class="content-area">
  <main id="main" class="site-main" role="main">
     ...
     */ 
      $args = array( 'post_type' => 'program', 'order' => 'ASC', 'posts_per_page' => 666, 'program_type' => 'fitness');
