<?php
/**
 * The template for displaying all Seniors - arts & dance programs.
 *
 * @package based on RED_Starter_Theme
 * Template Name: Seniors - Arts & Dance Programs Template
 */
get_header(); ?>
...
<div id="primary" class="content-area">
  <main id="main" class="site-main" role="main">
     ...
     */ 
      $args = array( 'post_type' => 'program', 'order' => 'ASC', 'posts_per_page' => 666, 'program_type' => 'arts-dance');
