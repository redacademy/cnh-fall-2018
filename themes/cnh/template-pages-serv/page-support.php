<?php
/**
 * The template for displaying all senior - support services.
 *
 * @package based on RED_Starter_Theme
 * Template Name: Seniors- Support Services Template
 */
get_header(); ?>
...
<div id="primary" class="content-area">
  <main id="main" class="site-main" role="main">
     ...
     */ 
      $args = array( 'post_type' => 'service', 'order' => 'ASC', 'posts_per_page' => 666, 'service_type' => 'support');
